...
def dim_customer(
    ...
    """
    Create dim_customers from silver tables
    """
...
def dim_seller(context, silver_cleaned_seller: DataFrame):
    """
    Create dim_seller from silver tables
    """
...
def dim_review(context, silver_cleaned_order_review: DataFrame):
    """
    Create dim_review from silver tables
    """
...
def dim_product(
    ...
    """
    Create dim_product from silver tables
    """
...
def dim_order(context, silver_cleaned_order, silver_cleaned_payment: DataFrame):
    """
    Create dim_order from silver tables
    """
...
def dim_date(context, silver_date: DataFrame):
    """
    Create dim_date from silver tables
    """
