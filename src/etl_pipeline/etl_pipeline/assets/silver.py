...
def silver_cleaned_seller(context, bronze_seller: pl.DataFrame):
    """
    Load 'seller' table from bronze layer in minIO, into a Spark dataframe, then clean data
    """
...
def silver_cleaned_product(context, bronze_product: pl.DataFrame):
    """
    Load 'product' table from bronze layer in minIO, into a Spark dataframe, then clean data
    """
...
def silver_cleaned_order_item(context, bronze_order_item: pl.DataFrame):
    """
    Load 'order_items' table from bronze layer in minIO, into a Spark dataframe, then clean data
    """
...
def silver_cleaned_payment(context, bronze_payment: pl.DataFrame):
    """
    Load 'payment' table from bronze layer in minIO, into a Spark dataframe, then clean data
    """
...
def silver_cleaned_order_review(context, bronze_order_review: pl.DataFrame):
    """
    Load 'order_review' table from bronze layer in minIO, into a Spark dataframe, then clean data
    """
...
def silver_cleaned_product_category(context, bronze_product_category: pl.DataFrame):
    """
    Load 'product_category' table from bronze layer in minIO, into a Spark dataframe, then clean data
    """
...
def silver_cleaned_order(context, bronze_order: pl.DataFrame):
    """
    Load 'order' table from bronze layer in minIO, into a Spark dataframe, then clean data
    """
    context.log.debug("Start creating spark session")
    with get_spark_session(None, str(context.run.run_id).split("-")[0]) as spark:
        # Convert bronze_book from polars DataFrame to Spark DataFrame
...
def silver_date(context, bronze_order: pl.DataFrame):
    """
    Load 'date' table using orders from bronze layer, into a Spark dataframe, then clean data
    """
    context.log.info("Got Spark DataFrame")
    # spark_df.unpersist()
    context.log.debug("Start creating spark session")
...
def silver_cleaned_geolocation(context, bronze_geolocation: pl.DataFrame):
    """
    Load 'geolocation' table from bronze layer in minIO, into a Spark dataframe, then clean data
    """
